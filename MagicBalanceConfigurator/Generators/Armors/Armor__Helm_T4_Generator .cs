...
{
    internal class Armor_Helm_T4_Generator : BaseArmorGenerator
    {
        public Armor_Helm_T4_Generator(RandomController controller) : base(controller, Consts.Armor_Helm_T4_FileName) 
        {
            ...
            SetArmorProtectionRange(80, 120);
            SetItemCondRange(200, 350);
        ...
        protected override List<ItemTemplatePreset> BuildItemTemplatePresets() => new List<ItemTemplatePreset>()
        {
            ...
            new ItemTemplatePreset()
            {
                ...
                AltOnEquipFunc = "equip_itar_helm_g3_04();",
                AltOnUnEquipFunc = "unequip_itar_helm_g3_04();",
                ProtFireMult = 0.5,
                ProtMagicMult = 0.5,
                ProtPointMult = 0.75,
                ProtBluntMult = 1.25,
            ...
            new ItemTemplatePreset()
            {
                ...
                AltOnEquipFunc = "equip_itar_helm_g3_02();",
                AltOnUnEquipFunc = "unequip_itar_helm_g3_02();",
                ProtFireMult = 0.75,
                ProtMagicMult = 0.75,
                ProtPointMult = 1.0,
                ProtBluntMult = 1.0,
