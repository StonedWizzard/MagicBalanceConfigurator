...
{
    internal class Weap_1h_T3_Generator : BaseWeaponGenerator
    {
        public Weap_1h_T3_Generator(RandomController controller) : base(controller, Consts.Weap_1h_T3_FileName) 
        {
        ...
        protected override List<ItemTemplatePreset> BuildItemTemplatePresets() => new List<ItemTemplatePreset>()
        {
            ...
            new ItemTemplatePreset()
            {
                ...
                AltOnEquipFunc = "equip_1h_heavy();",
                AltOnUnEquipFunc = "unequip_1h_heavy();",
                WeaponExtraRange = -10
            },
            // rapiers
            new ItemTemplatePreset()
