...
{
    internal class Weap_2h_T3_Generator : BaseWeaponGenerator
    {
        public Weap_2h_T3_Generator(RandomController controller) : base(controller, Consts.Weap_2h_T3_FileName) 
        {
