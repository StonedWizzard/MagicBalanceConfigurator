...
{
    internal class Armor_Body_T4_Generator : BaseArmorGenerator
    {
        public Armor_Body_T4_Generator(RandomController controller) : base(controller, Consts.Armor_Body_T4_FileName) 
        {
